...
class carpoolBoard: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating,UIPopoverPresentationControllerDelegate {
    var values:NSArray = []
    var school = "QUEENS"
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(carpoolBoard.refreshVC), name:"refresh", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(carpoolBoard.methodhandlingTheNotificationEvent), name:"NotificationIdentifie‌​r", object: nil)
...
//        }
    ...
    func get(){
        let request = NSMutableURLRequest(URL: NSURL(string: "http://www.percyteng.com/orbit/getRide.php")!)
        ...
        let task = NSURLSession.sharedSession().dataTaskWithRequest(request) {
            ...
            let array:NSArray = responseString!["rides"] as! NSArray
            var temp = NSMutableArray()
    ...
    @IBAction func createPost(sender: AnyObject) {
        ...
        let popOverVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("rideshareBoard") as! createRideshare
