...
class createRideshare: UIViewController {
    var username = String()
    var school = String()
    ...
    override func viewDidLoad() {
        ...
        self.showAnimate()
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(createRideshare.keyboardWillShow(_:)), name:UIKeyboardWillShowNotification, object: nil);
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(createRideshare.keyboardWillHide(_:)), name:UIKeyboardWillHideNotification, object: nil);
    ...
    @IBAction func post(sender: AnyObject) {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://www.percyteng.com/orbit/createRideshare.php")!)
