...
if (isset($_POST['username'])&& isset($_POST['notes']) && isset($_POST['newComment'])) {
...
//         // connecting to db
        $con = new DB_CONNECT();
        $db = $con->connect();
        $result = $db->prepare("UPDATE sports SET comments = concat(ifnull(comments,:newComment),:newComment) WHERE username = :username AND notes = :notes");
