...
import percy.SocialQ.SocialQ.Boards.exchangeBoard;
import percy.SocialQ.SocialQ.R;

public class createExchange extends Activity implements View.OnClickListener{
    ...
    final int UO = 4;
    Button submitButton;
    EditText itemText, costText, notesText;
    TextView name;
    @Override
...
// Add request to queue
        String url = "http://percyteng.com/orbit/createExchange.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                proDia.dismiss();
                                Intent i = new Intent(createExchange.this, exchangeBoard.class);
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("item", itemText.getText().toString());
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.back) {
            ...
            if (itemText.getText().toString().isEmpty() || itemText.getText().toString().length() == 0 || itemText.getText().toString() == null)
                itemText.setError("Item name is required!");
            else if (itemText.getText().toString().length()>50)
                itemText.setError("Item name has to be shorter than 50 chracters.");
