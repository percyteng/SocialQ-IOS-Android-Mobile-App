...
import percy.SocialQ.SocialQ.Boards.eventBoard;
...
public class createEvents extends Activity implements  View.OnClickListener{
    ...
    Button submitButton;
    EditText  locationText, costText, notesText, eventText;
    TextView name;
    final int QUEENS = 0;
    final int UWO = 1;
    final int UOT = 2;
...
// Add request to queue
        String url = "http://percyteng.com/orbit/createEvents.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                proDia.dismiss();
                                Intent i = new Intent(createEvents.this, eventBoard.class);
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("title", eventText.getText().toString());
                return params;
            }
        };
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.back) {
            ...
            if (eventText.getText().toString().isEmpty() || eventText.getText().toString().length() == 0 || eventText.getText().toString() == null)
                eventText.setError("Event name is required!");
            else if (eventText.getText().toString().length()>50)
                eventText.setError("User name has to be shorter than 50 chracters.");
            else if (locationText.getText().toString().isEmpty() || locationText.getText().toString().length() == 0 || locationText.getText().toString() == null)
                locationText.setError("Location is required!");
            else if (locationText.getText().toString().length()>50)
                locationText.setError("Location name has to be shorter than 50 chracters.");
