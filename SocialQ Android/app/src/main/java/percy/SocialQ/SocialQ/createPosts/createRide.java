...
import percy.SocialQ.SocialQ.Boards.carPoolBoard;
import percy.SocialQ.SocialQ.R;

public class createRide extends Activity implements View.OnClickListener {
...
// Add request to queue
        String url = "http://percyteng.com/orbit/createRideshare.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                proDia.dismiss();
                                Intent i = new Intent(createRide.this, carPoolBoard.class);
        ...
        if (v.getId() == R.id.back) {
            ...
            startActivity(i);
                ...
                if (locationText.getText().toString().isEmpty() || locationText.getText().toString().length() == 0 || locationText.getText().toString() == null)
                    ...
                    notesText.setError("Price has to be shorter than 30 chracters.");
