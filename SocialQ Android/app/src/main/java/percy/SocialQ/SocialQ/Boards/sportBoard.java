...
import percy.SocialQ.SocialQ.createPosts.createSports;
                        ...
                        try {
                            ...
                            for (int i = jsonResponse.length()-1; i >= 0; i--){
                                ...
                                if (school.equals(userSchool)) {
                                    ...
                                    fullList.add(new Posts(type, location, username, notes, school));
//                                    createLayout(username, location, type, notes, school);
                            ...
                            generateListContent();
                            adapter = new MyListAdaper(sportBoard.this, R.layout.posts, data);
                            lv.setAdapter(adapter);
...
//            types.setText(type);
//        else
//            types.setText(type.substring(0,13) + "...");
//        relay.addView(types);
//
...
//                }
//            });
            mainViewholder.price.setVisibility(View.GONE);
            mainViewholder.thumbnail.setBackground(getResources().getDrawable(R.drawable.sports));
            mainViewholder.title.setText("SPORTS");
            if (getItem(position).type.length() < 10)
                mainViewholder.eventName.setText(getItem(position).type);
            else
                mainViewholder.eventName.setText(getItem(position).type.substring(0,7) + "...");
            ...
            mainViewholder.delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(getItem(position).username, getItem(position).type, getItem(position).location, getItem(position).notes, "Sports", getItem(position).school);
