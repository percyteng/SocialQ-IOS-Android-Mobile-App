 ...
 */
public class inboxClass extends Fragment implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    String username;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.inbox_fragment, container, false);
...
//        getVolley();
    ...
    private void initTabHost() {
        tabHost = (TabHost) myFragmentView.findViewById(android.R.id.tabhost);
    ...
    private void initViewPager(){
        viewPager = (ViewPager) myFragmentView.findViewById(R.id.vew_pager);
        ...
        listFragments.add(new outbox());

        myFragmentPagerListener myListener = new myFragmentPagerListener(getFragmentManager(), listFragments);
...
//
//    public void getImages(final ImageView userPic, String from){
//        String url = "http://percyteng.com/orbit/pictures/" + from +".JPG";
...
//                                    String ifRead = eachPosts.getString("ifRead");
//                                    String time = eachPosts.getString("time");
//                                    String cameFrom = eachPosts.getString("cameFrom");
//                                    createLayout(from, to, subject, content, ifRead, time, cameFrom);
//                                }
//                                proDia.dismiss();
//                            }
...
//        mRequestQueue.start();
//// Add request to queue
//        String url = "http://percyteng.com/orbit/updateIfread.php";
//        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
//                new Response.Listener<String>() {
//                    @Override
//                    public void onResponse(String response) {
...
//                            int result = new JSONObject(response).getInt("success");
//                            if (result == 1) {
//                                System.out.println("You have read this message");
//                            } else {
//                                String message = new JSONObject(response).getString("message");
//                                alert(message);
//                            }
...
//    }
//
//    public void createLayout(final String from,final String to, final String subject, final String content, final String ifRead, final String time, final String cameFrom){
...
//                bundle.putString("cameFrom", "inbox");
