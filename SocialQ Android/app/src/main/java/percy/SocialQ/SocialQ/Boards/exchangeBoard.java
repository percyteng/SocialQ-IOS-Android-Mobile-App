...
import percy.SocialQ.SocialQ.createPosts.createExchange;
import percy.SocialQ.SocialQ.posts.Posts;

public class exchangeBoard extends AppCompatActivity implements View.OnClickListener {
    Posts[] arrItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exchange_board);
...
// Add request to queue
        String url = "http://percyteng.com/orbit/getExchange.php";
        final JsonObjectRequest jsonRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonResponse = response.getJSONArray("exchange");
...
//                                    createLayout(username, item, price, notes, school);
                                    fullList.add(new Posts(price, item, username, notes, school));
                                }
                                proDia.dismiss();
                            }
                            ...
                            generateListContent();
                            adapter = new MyListAdaper(exchangeBoard.this, R.layout.posts, data);
                            lv.setAdapter(adapter);
    ...
    public void createLayout(final String name, final String item, final String price, final String notes, final String school){
        ...
        relay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(exchangeBoard.this, Comments.class);
                Bundle bundle = new Bundle();
                bundle.putString("category", "exchange");
        ...
        if (name.equals(username) || username.equals("admin")){
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(name, price, item, notes, "exchange", school);
                }
            });
        }
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Login",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        // current activity
                        startActivity(new Intent(exchangeBoard.this, Signin.class));
                        finish();
                    }
                })
    ...
    public void deleteVolley(final String name, final String price, final String item, final String notes, final String category, final String school){
        final ProgressDialog proDia = new ProgressDialog(this);
        proDia.setTitle("Processing");
        proDia.setMessage("Please wait...");
        proDia.show();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                Intent i = new Intent(exchangeBoard.this, exchangeBoard.class);
                                Bundle bundle = new Bundle();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.back)
            ...
            if (username.equals("Visitor")){
                ...
                Intent i = new Intent(this, createExchange.class);
                Bundle bundle = new Bundle();
                bundle.putString("username", username);
                bundle.putString("school", userSchool);
                i.putExtras(bundle);
...
//            });
            ...
            mainViewholder.thumbnail.setBackground(getResources().getDrawable(R.drawable.exchange));
            mainViewholder.title.setText("SELL&BUY");
            ...
            mainViewholder.relay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("item", getItem(position).location);
            ...
            mainViewholder.delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(getItem(position).username, getItem(position).type, getItem(position).location, getItem(position).notes, "exchange", getItem(position).school);
