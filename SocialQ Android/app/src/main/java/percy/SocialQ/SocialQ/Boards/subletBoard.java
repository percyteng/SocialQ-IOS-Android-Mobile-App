...
import percy.SocialQ.SocialQ.createPosts.subletPost;
import percy.SocialQ.SocialQ.posts.Posts;

public class subletBoard extends AppCompatActivity implements  View.OnClickListener{
    Posts[] arrItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sublet_board);
...
// Add request to queue
        String url = "http://percyteng.com/orbit/getSublet.php";
        final JsonObjectRequest jsonRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonResponse = response.getJSONArray("subletting");
...
//                                    createLayout(username, location, price, notes, school);
                            ...
                            generateListContent();
                            adapter = new MyListAdaper(subletBoard.this, R.layout.posts, data);
                            lv.setAdapter(adapter);
...
//        relay.setElevation(4);
        ...
        relay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(subletBoard.this, Comments.class);
                Bundle bundle = new Bundle();
                bundle.putString("category", "Sublet");
        ...
        if (name.equals(username) || username.equals("admin")){
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(name, price, location, notes, "Sublet", school);
                }
            });
        }
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Login",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        // current activity
                        startActivity(new Intent(subletBoard.this, Signin.class));
                        finish();
                    }
                })
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                Intent i = new Intent(subletBoard.this, subletBoard.class);
                                Bundle bundle = new Bundle();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.createPost) {
            if (username.equals("Visitor")) {
                ...
                Intent i = new Intent(this, subletPost.class);
                Bundle bundle = new Bundle();
                bundle.putString("username", username);
...
//            });
            ...
            mainViewholder.thumbnail.setBackground(getResources().getDrawable(R.drawable.sublet));
            mainViewholder.title.setText("SUBLET&LEASES");
            ...
            mainViewholder.delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(getItem(position).username, getItem(position).type, getItem(position).location, getItem(position).notes, "Sublet", getItem(position).school);
