...
import percy.SocialQ.SocialQ.Boards.serviceBoard;
import percy.SocialQ.SocialQ.R;

public class createServices extends Activity implements View.OnClickListener{
    ...
    final int UO = 4;
    Button submitButton;
    EditText titleText, costText, notesText;
    TextView name;
    @Override
...
// Add request to queue
        String url = "http://percyteng.com/orbit/createServices.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                proDia.dismiss();
                                Intent i = new Intent(createServices.this, serviceBoard.class);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.back) {
            ...
            if (titleText.getText().toString().isEmpty() || titleText.getText().toString().length() == 0 || titleText.getText().toString() == null)
                titleText.setError("Service name is required!");
            else if (titleText.getText().toString().length()>50)
                titleText.setError("Service name has to be shorter than 50 chracters.");
