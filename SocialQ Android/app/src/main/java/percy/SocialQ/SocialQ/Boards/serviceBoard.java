...
import percy.SocialQ.SocialQ.createPosts.createServices;
import percy.SocialQ.SocialQ.posts.Posts;

public class serviceBoard extends AppCompatActivity implements View.OnClickListener{
    Posts[] arrItems;
...
// Add request to queue
        String url = "http://percyteng.com/orbit/getServices.php";
        final JsonObjectRequest jsonRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonResponse = response.getJSONArray("services");
                            for (int i = jsonResponse.length()-1; i >= 0; i--){
                                ...
                                if (school.equals(userSchool)) {
                                    ...
                                    String titles = eachActivity.getString("title");
                                    String price = eachActivity.getString("price");
                                    String notes = eachActivity.getString("notes");
//                                    createLayout(username, titles, null, price, notes, school);
                                    fullList.add(new Posts(price, titles, username, notes, school));
                                }
                                proDia.dismiss();
                            }
                            ...
                            generateListContent();
                            adapter = new MyListAdaper(serviceBoard.this, R.layout.posts, data);
                            lv.setAdapter(adapter);
    ...
    public void createLayout(final String name, final String titles, final String location, final String price, final String notes, final String school){
...
//        relay.setElevation(4);
        ...
        relay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(serviceBoard.this, Comments.class);
...
//                @Override
//                public void onClick(View v) {
//                    deleteVolley(name, price, location, notes, "Services", school);
//
//                }
//            });
//        }
        ...
        if(titles.length() <15)
            locate.setText(titles);
        else
            locate.setText(titles.substring(0,13) + "...");
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Login",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        // current activity
                        startActivity(new Intent(serviceBoard.this, Signin.class));
                        finish();
                    }
                })
    ...
    public void deleteVolley(final String name, final String price, final String location, final String notes, final String category, final String school){
        alert(price+name+location+notes+category);
        final ProgressDialog proDia = new ProgressDialog(this);
        proDia.setTitle("Processing");
        proDia.setMessage("Please wait...");
        proDia.show();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result == 1) {
                                ...
                                Intent i = new Intent(serviceBoard.this, serviceBoard.class);
                                Bundle bundle = new Bundle();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.createPost) {
            if (username.equals("Visitor")) {
                ...
                Intent i = new Intent(this, createServices.class);
                Bundle bundle = new Bundle();
                bundle.putString("username", username);
...
//            });
            ...
            mainViewholder.thumbnail.setBackground(getResources().getDrawable(R.drawable.services));
            mainViewholder.title.setText("SERVICES");
            ...
            mainViewholder.relay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("titles", getItem(position).location);
...
//                @Override
//                public void onClick(View v) {
//                    deleteVolley(getItem(position).username, getItem(position).type, getItem(position).location, getItem(position).notes, "service", getItem(position).school);
//
//                }
//            });
            return convertView;
