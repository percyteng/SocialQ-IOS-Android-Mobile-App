...
import percy.SocialQ.SocialQ.createPosts.createEvents;
                        ...
                        try {
                            ...
                            for (int i = jsonResponse.length()-1; i >= 0; i--){
                                ...
                                if(school.equals(userSchool)) {
                                    ...
                                    fullList.add(new Posts(title, location, price, username, notes, school));
//                                    createLayout(username, location, price, notes, title, school);
                            ...
                            generateListContent();
                            adapter = new MyListAdaper(eventBoard.this, R.layout.posts, data);
                            lv.setAdapter(adapter);
...
//        else
//            nameEvents.setText(titles.substring(0,7) + "...");
...
//            });
            ...
            mainViewholder.delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    deleteVolley(getItem(position).username, getItem(position).price, getItem(position).location, getItem(position).notes, "Events", getItem(position).school);
